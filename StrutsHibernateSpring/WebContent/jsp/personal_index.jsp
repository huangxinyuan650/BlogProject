...
<div class="container">
  ...
  <!-- end .header --></div>
  <div class="sidebar1" style="background-color: #FFFFFF">
    <ul class="nav">
      <li><p>作者文章表列</p></li>
      <li><a href="#" style="background-color: #FFFFFF">文章一</a></li>
      <li><a href="#" style="background-color: #FFFFFF">文章二</a></li>
      <li><a href="#" style="background-color: #FFFFFF">文章三</a></li>
      <li><a href="#" style="background-color: #FFFFFF">文章四</a></li>
      <li><a href="#" style="background-color: #FFFFFF">更多文章</a></li>
    </ul>
  
    <!-- end .sidebar1 --></div>
  <div class="content">
  	<div align="center" style="background-color: #E0EEEE">
    	<input type="text" readonly="readonly" name="blogTitle" size="50px"  style="font-size:28px; text-align: center;border: none;background-color: transparent;" value="作者介绍" width="780px" height="30px" border=0/>
    	<textarea rows="50" cols="62" style="width: 780px;height: 750px;border: none;font-size: 18px;background-color: transparent;" readonly="readonly">黄鑫源</textarea>
    </div>
    
    <!-- end .content --></div>
    <div class="footer" align="right" style="background-color: #1C86EE">
  	<br />
