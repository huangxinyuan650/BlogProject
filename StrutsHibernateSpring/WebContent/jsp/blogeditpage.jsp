  ...
  <div class="content">
  	<form method="post" id="editForm">
  		<div align="center" style="width:100%;height:40px">
  			<input type="text" name="title" style="height: 100%;width: 99%;text-align: center;" align="bottom" value="请输入标题"/>
  		</div>
  	  <textarea id="editArea" style="width:100%;height:100%" rows="55" cols="50"></textarea>
  	  <br/>
