...
<div class="container">
  ...
  <div class="sidebar1">
    ...
    <form action="">
    	<table>
    		<caption>用户信息简介</caption>
    		<tr>
    			<td>姓名：</td>
    			<td><hxy:property value="userDetailInfo.realName"/></td>
    		</tr>
    		<tr>
    			<td>性别:</td>
    			<td><hxy:property value="userDetailInfo.gender"/></td>
    		</tr>
    		<tr>
    			<td>公司：</td>
    			<td><hxy:property value="userDetailInfo.company"/></td>
    		</tr>    		
    	</table>
    	<table>
    		<thead>个人简介</thead>
    		<caption><textarea rows="10" cols="19" readonly="readonly"><hxy:property value="userDetailInfo.introduce"/></textarea></caption>
    	</table>
    </form>
    <!-- end .sidebar1 --></div>
  <div class="content">
  	<form style="text-align: right;height: 30px;width: 100%;" action="newWrite">
  		<input type="submit" value="新建文章" name="newWrite" align="right"/>
  	</form>
  	<!-- 这里用来显示该用户的所有文章标题和时间的链接，点击链接进入文章详情 -->
  	<form style="text-align: center;height: 100%;width: 100%;" action="testTwo">
  		<table style="height: 100%;width: 100%;">
  			<!-- 使用迭代器将查处的用户的文章标题表列显示在table中 -->
  			<caption>文章信息表列</caption>
  			<tr>
  			<td><input type="hidden" name="arid" value="文章id"/></td>
  			<td></td>
  			<td align="left"><input type="submit" value="新建文章"/></td>
  			</tr>
  			<!-- <tr align="left" style="text-align: left;">
  				<td><a href="#">1.文章标题</a></td>
  				<td align="center">时间</td>
  				<td align="right"><input type="submit" value="文章详情"/></td>
  			</tr>
  			<tr align="left" style="text-align: left;">
  				<td><a href="#">2.文章标题</a></td>
  				<td align="center">时间</td>
  				<td align="right"><input type="submit" value="文章详情"/></td>
  			</tr> -->
  			<hxy:iterator id="briefInfo" value="blogBriefInfoList">
  				<tr align="left" style="text-align: left;">
  					<td><a href="#">1.<hxy:property value="#briefInfo.blogTitle"/></a></td>
  					<td align="left"><hxy:property value="#briefInfo.writeTime"/></td>
  					<td align="left"><input type="submit" value="<hxy:property value="#briefInfo.id"/>详情" name=""></input></td>
  				</tr>
  			</hxy:iterator>
  		</table>
  	</form>
  	<form action="">
  	<table><tr><td><a>文章</a></td><td><input type="submit" value="文章详情"/></td></tr></table>
  	<input ></input>
  	</form>
  			...
  			<tr>
  				<td>
  					<form action="showDetail">
  						<table style="text-align: center;height: 100%;width: 100%;">
  							<tr>
  								<td><input type="hidden" value="<hxy:property value="#briefInfo.id"/>" name="blogId"/></td>
  								<td align="left"><hxy:property value="#briefInfo.blogTitle"/></td>
  								<td align="left"><hxy:property value="#briefInfo.writeTime"/></td>
  								<td align="left"><input type="submit" value="文章详情" name=""></input></td>
  							</tr>
  						</table>
  					</form>
  				</td>
  ...
  <div class="sidebar2">
  <!-- 
  	<form style="height:100px; width:100%">
    	<table style="height:100%; width:100%">
        	<tr><input type="submit" value="新建文章" height="35px"/></tr>
        </table>
    </form> -->
    <!-- end .sidebar2 --></div>
