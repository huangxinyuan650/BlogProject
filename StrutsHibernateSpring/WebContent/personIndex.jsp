...
<div class="container">
  ...
  <div class="content">
  	...
  	<form action="" style="text-align: center;height: 100%;width: 100%;">
  		<table style="height: 100%;width: 100%;">
  			...
  			<tr align="left" style="text-align: left;">
  				<td><a href="#">3.文章标题</a></td>
  				<td align="right">时间</td>
  			</tr>
  			<tr align="left" style="text-align: left;">
  				<td><a href="#">4.文章标题</a></td>
  				<td align="right">时间</td>
  			</tr>
  			<tr align="left" style="text-align: left;">
  				<td><a href="#">5.文章标题</a></td>
  				<td align="right">时间</td>
  			</tr>
  			<hxy:iterator id="briefInfo" value="blogBriefInfoList">
  				<tr>
  					<td><hxy:property value="#briefInfo.blogTitle"/></td>
  					<td><hxy:property value="#briefInfo.writeTime"/></td>
  				</tr>
  			</hxy:iterator>
  		</table>
  	</form>
