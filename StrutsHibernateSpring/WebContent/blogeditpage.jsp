...
<div class="container">
  <div class="header" style="width:100%;height:100%" id="head">
    <table width="100%" height="131" border="0">
      <tr>
        <td width="23%" align="center">
        	<label><font color="#FFF" size="5">航运新人论坛</font></label>
        </td>
        <td width="58%">&nbsp;</td>
        <td width="19%"><table width="100%" height="28%" border="0">
          <tr>
            <td height="67">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td height="64" align="center"><label id="userNamel">当前用户</label></td>
            <td align="center"><label id="userName"><%=request.getSession().getAttribute("userName") %></label></td>
          </tr>
        </table></td>
      </tr>
    </table>
  ...
  <div class="content">
  	<form method="post" id="editForm">
  		<div align="center" style="width:100%;height:40px">
  			<input type="text" name="articalTitle" id="articalTitle" style="height: 100%;width: 99%;text-align: center;" align="bottom" value="请输入标题"/>
  		</div>
  	  <textarea id="editArea" name="editArea" style="width:100%;height:100%" rows="55" cols="50"></textarea>
  	  <br/>
  	  <div align="right" style="width:100%;height:100%">
  	  	<input type="submit" value="提交" onclick="saveArtical()" align="right" size="10" style="width: 60px;height: 30px"/>  	  	
  	  </div>
  	</form>
  <!-- end .content --></div>
  <div class="sidebar2">
  ...
  <div class="footer">
    <p align="right">
    	<font color="#3399FF">Powerd by Bluesir</font>    	
    </p>
    <!-- end .footer -->
  </div>
  <!-- end .container --></div>
