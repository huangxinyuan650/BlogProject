...
<div class="container">
    ...
    <div>
      <table width="882" border="1">
        <tr>
          ...
          <td width="418">&nbsp;</td>
          <td width="205"><table width="100%" height="118" border="1">
            <tr>
              <td>&nbsp;</td>
            </tr>
            <tr>
  ...
  <div class="content">
    <h1>说明</h1>
    <p>请注意，这些布局的 CSS 带有大量注释。如果您的大部分工作都在设计视图中进行，请快速浏览一下代码，获取有关如何使用液态布局 CSS 的提示。您可以先删除这些注释，然后启动您的站点。要了解有关这些 CSS 布局中使用的方法的更多信息，请阅读 Adobe 开发人员中心上的以下文章。</p>
    <h2>清除方法</h2>
